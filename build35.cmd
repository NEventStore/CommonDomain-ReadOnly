...
msbuild /nologo /verbosity:quiet src/CommonDomain.sln /p:Configuration=Release /property:TargetFrameworkVersion=v3.5
...
bin\ilmerge-bin\ILMerge.exe /keyfile:src/CommonDomain.snk /xmldocs /v2 /out:output/CommonDomain.dll %FILES_TO_MERGE%
